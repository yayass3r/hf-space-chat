      ...
      <div className="flex flex-col flex-1 min-w-0">
        ...
        <header className="flex items-center justify-between px-4 sm:px-6 py-3 border-b border-slate-200 dark:border-slate-800 bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm">
          ...
          <div className="flex items-center gap-1">
            ...
            <button onClick={() => setShowSystemPromptEditor(!showSystemPromptEditor)} className={`p-2 rounded-lg transition-colors ${showSystemPromptEditor ? "text-violet-500 bg-violet-50 dark:bg-violet-900/20" : "text-slate-500 hover:text-violet-600 dark:text-slate-400 dark:hover:text-violet-400 hover:bg-slate-100 dark:hover:bg-slate-800"}`} title="تعليمات مخصصة للذكاء الاصطناعي">
