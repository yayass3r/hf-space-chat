...
export default function Home() {
  ...
  const sendMessage = useCallback(async () => {
    ...
    // Create session if needed and save to Supabase
  ...
  }, [input, isLoading, spaceUrl, currentSessionId]);
  ...
  return (
    <div className="flex h-screen bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-950 dark:to-slate-900">
      ...
      {isSupabaseConfigured && dbStatus === "connected" && (
        <aside className="hidden md:flex flex-col w-64 border-r border-slate-200 dark:border-slate-800 bg-white/60 dark:bg-slate-900/60 backdrop-blur-sm">
      ...
      <div className="flex flex-col flex-1 min-w-0">
          ...
          <div className="px-4 sm:px-6 py-4 border-b border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 space-y-3">
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 rounded-lg border border-slate-300 dark:border-slate-600 bg-slate-50 dark:bg-slate-800 text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent text-sm"
              />
            </div>
            <div className="grid grid-cols-2 gap-3 text-xs">
              ...
              <div className="px-3 py-2 rounded-lg bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700">
                <span className="text-slate-500 dark:text-slate-400">DB Status</span>
          ...
          {messages.length === 0 && (
            <div className="flex flex-col items-center justify-center h-full text-center">
              ...
              <p className="text-slate-500 dark:text-slate-400 max-w-md mb-8">
                ...
                {isSupabaseConfigured && " Your conversations are saved to Supabase."}
              </p>
        ...
        <div className="px-4 sm:px-6 py-3 border-t border-slate-200 dark:border-slate-800 bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm">
          ...
          <p className="mt-1.5 text-center text-xs text-slate-400 dark:text-slate-500">
            {spaceUrl.replace("https://", "")} &middot; Enter = send &middot; Shift+Enter = new line
          </p>
        </div>
      </div>
    </div>
